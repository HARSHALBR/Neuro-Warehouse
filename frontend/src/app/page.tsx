...
import { Bot, Smartphone, Layers, ShieldCheck } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen p-3 md:p-5 flex flex-col gap-3.5 max-w-[1780px] mx-auto">
      {/* Header Bar */}
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-2 border-b border-slate-800/80">
        ...
        <div className="flex items-center gap-3">
          <div className="bg-[#090d16] border border-slate-800 px-3.5 py-1.5 rounded-xl text-xs font-mono flex items-center gap-2">
          ...
          <a
            ...
            className="bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/40 text-blue-300 px-3 py-1.5 rounded-xl text-xs font-semibold flex items-center gap-1.5 transition-colors"
          >
            <Smartphone className="w-4 h-4 text-blue-400" />
            <span>iQOO Field Operator</span>
          </a>
        </div>
      </header>
      ...
      {/* 3. Main Command Center Grid: 3D Canvas + Telemetry / Deliberation HUD */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 flex-1">
        {/* Left 3D Digital Twin Viewport (8 Cols) */}
        <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-3">
          <div className="flex-1 min-h-[520px] xl:min-h-[600px]">
        ...
        {/* Right HUD: Thought Stream & Deliberation Matrix (4 Cols) */}
